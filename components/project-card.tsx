...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col rounded-xl border border-zinc-800 bg-zinc-950/60 p-6 backdrop-blur-md transition hover:border-orange-500/60 hover:shadow-[0_0_30px_-12px_rgba(249,115,22,0.45)]"
    >
